...
const backend: AppConfig = makeApp("backend", "/ws/backend", null, [
  { name: "worker", port: 8080, forward: true, alias: null },
]);
...
const standalone: AppConfig = makeApp("localtools", "/ws/localtools", "devbox-c", [
  { name: "ui", port: 9000, forward: false, alias: "ui.localtools.local" },
]);
